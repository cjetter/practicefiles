## Sec 5.5 - Radio Button Group: Changing Labels Dynamically
...
# create widgets
options=['student_names','average_grades','exam_grades'] # list of strings of column in CDS
radio_button_group = RadioButtonGroup(labels=options,active=0)
